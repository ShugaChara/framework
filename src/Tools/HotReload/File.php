...
namespace ShugaChara\Framework\Tools\HotReload;

/**
 * Class File
 * @package ShugaChara\Framework\Tools\HotReload
 */
class File
{
    /**
    ...
    static function copyFile($source, $target, $overwrite = true)
    {
        ...
        else if (file_exists($target) && $overwrite == true) {
    ...
    static function touchFile($filePath, $overwrite = true)
    {
        if (file_exists($filePath) && $overwrite == false) {
            return false;
        } else if (file_exists($filePath) && $overwrite == true) {
            if (!unlink($filePath)) {
                return false;
            }
        }
